...
if(o&&!i){++a
break}}}o&&!i&&(t.fatArrowAt=a)}}function c(e,t,r,n,i,o){this.indented=e,this.column=t,this.type=r,this.prev=i,this.info=o,null!=n&&(this.align=n)}function d(e,t){for(var r=e.localVars;r;r=r.next)if(r.name==t)return!0
for(var n=e.context;n;n=n.prev)for(var r=n.vars;r;r=r.next)if(r.name==t)return!0}function f(e,t,r,n,i){var o=e.cc
...
return"=>"==e?p(m,r?D:z,v):"operator"==e?/\+\+|--/.test(t)||ze&&"!"==t?p(n):"?"==t?p(k,w(":"),i):p(i):"quasi"==e?h(O,n):";"!=e?"("==e?K(C,")","call",n):"."==e?p(F,n):"["==e?p(y("]"),M,w("]"),b,n):ze&&"as"==t?(Re.marked="keyword",p(q,n)):void 0:void 0}function O(e,t){return"quasi"!=e?h():"${"!=t.slice(t.length-2)?p(O):p(k,W)}function W(e){if("}"==e)return Re.marked="string-2",Re.state.tokenize=s,p(O)}function z(e){return u(Re.stream,Re.state),h("{"==e?x:k)}function D(e){return u(Re.stream,Re.state),h("{"==e?x:C)}function H(e){return function(t){return"."==t?p(e?E:P):"variable"==t&&ze?p(Z,e?A:N):h(e?C:k)}}function P(e,t){if("target"==t)return Re.marked="keyword",p(N)}function E(e,t){if("target"==t)return Re.marked="keyword",p(A)}function I(e){return":"==e?p(b,x):h(N,w(";"),b)}function F(e){if("variable"==e)return Re.marked="property",p()}function R(e,t){return"async"==e?(Re.marked="property",p(R)):"variable"==e||"keyword"==Re.style?(Re.marked="property",p("get"==t||"set"==t?B:j)):"number"==e||"string"==e?(Re.marked=Oe?"property":Re.style+" property",p(j)):"jsonld-keyword"==e?p(j):"modifier"==e?p(R):"["==e?p(k,w("]"),j):"spread"==e?p(k,j):":"==e?h(j):void 0}function B(e){return"variable"!=e?h(j):(Re.marked="property",p(ue))}function j(e){return":"==e?p(C):"("==e?h(ue):void 0}function V(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=Re.state.lexical
