...
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function D(e){return function t(r){return r==e?L():";"==e?S():L(t)}}function P(e,t){return"var"==e?L(W("vardef",t.length),he,D(";"),z):"keyword a"==e?L(W("form"),I,P,z):"keyword b"==e?L(W("form"),P,z):"keyword d"==e?C.stream.match(/^\s*$/,!1)?L():L(W("stat"),R,D(";"),z):"debugger"==e?L(D(";")):"{"==e?L(W("}"),te,z):";"==e?L():"if"==e?("else"==C.state.lexical.info&&C.state.cc[C.state.cc.length-1]==z&&C.state.cc.pop()(),L(W("form"),I,P,z,ye)):"function"==e?L(Se):"for"==e?L(W("form"),be,P,z):"class"==e||u&&"interface"==t?(C.marked="keyword",L(W("form"),Me,z)):"variable"==e?u&&"declare"==t?(C.marked="keyword",L(P)):u&&("module"==t||"enum"==t||"type"==t)&&C.stream.match(/^\s*\w/,!1)?(C.marked="keyword","enum"==t?L(Re):"type"==t?L(oe,D("operator"),oe,D(";")):L(W("form"),pe,D("{"),W("}"),te,z,z)):u&&"namespace"==t?(C.marked="keyword",L(W("form"),H,te,z)):L(W("stat"),_):"switch"==e?L(W("form"),I,D("{"),W("}","switch"),te,z,z):"case"==e?L(H,D(":")):"default"==e?L(D(":")):"catch"==e?L(W("form"),A,D("("),Le,D(")"),P,z,O):"export"==e?L(W("stat"),We,z):"import"==e?L(W("stat"),De,z):"async"==e?L(P):"@"==t?L(H,P):S(W("stat"),H,D(";"),z)}function H(e,t){return F(e,t,!1)}function E(e,t){return F(e,t,!0)}function I(e){return"("!=e?S():L(W(")"),H,D(")"),z)}function F(e,t,r){if(C.state.fatArrowAt==C.stream.start){var n=r?U:G
