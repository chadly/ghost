...
i.undone.length=0
var o,a,l=+new Date
if((i.lastOp==n||i.lastOrigin==t.origin&&t.origin&&("+"==t.origin.charAt(0)&&i.lastModTime>l-(e.cm?e.cm.options.historyEventDelay:500)||"*"==t.origin.charAt(0)))&&(o=function(e,t){return i.lastOp==n?(Wi(e.done),X(e.done)):e.done.length&&!X(e.done).ranges?X(e.done):e.done.length>1&&!e.done[e.done.length-2].ranges?(e.done.pop(),X(e.done)):void 0}(i)))a=X(o.changes),0==me(t.from,t.to)&&0==me(t.from,a.to)?a.to=yi(t):o.changes.push(Oi(e,t))
else{var s=X(i.done)
...
var n=[]
Ti(e,function(e,r){r||-1!=B(n,e.history)||(so(e.history,t),n.push(e.history)),io(e,t,null,Ae(e,t))})}}function ro(e,t,r){var n=e.cm&&e.cm.state.suppressEdits
...
break}if(Di(i,s),r&&!i.equals(e.sel))return void Gi(e,i,{clearRedo:!1})
a=i}var c=[]
Di(a,s),s.push({changes:c,generation:o.generation}),o.generation=i.generation||++o.maxGeneration
for(var d=ot(e,"beforeChange")||e.cm&&ot(e.cm,"beforeChange"),f=function(r){var n=i.changes[r]
if(n.origin=t,d&&!Ji(e,n,!1))return l.length=0,{}
c.push(Oi(e,n))
var o=r?wi(e,n):X(l)
io(e,n,o,Ei(e,n)),!r&&e.cm&&e.cm.scrollIntoView({from:n.from,to:yi(n)})
var a=[]
Ti(e,function(e,t){t||-1!=B(a,e.history)||(so(e.history,n),a.push(e.history)),io(e,n,null,Ei(e,n))})},h=i.changes.length-1;h>=0;--h){var p=f(h)
if(p)return p.v}}}}function no(e,t){if(0!=t&&(e.first+=t,e.sel=new pi(Y(e.sel.ranges,function(e){return new gi(ge(e.anchor.line+t,e.anchor.ch),ge(e.head.line+t,e.head.ch))}),e.sel.primIndex),e.cm)){Xn(e.cm,e.first,e.first-t,t)
...
t.lastWrapHeight==t.wrapper.clientHeight&&t.lastWrapWidth==t.wrapper.clientWidth||(t.cachedCharWidth=t.cachedTextHeight=t.cachedPaddingH=null,t.scrollbarsClipped=!1,e.setSize())}for(var Ao={3:"Pause",8:"Backspace",9:"Tab",13:"Enter",16:"Shift",17:"Ctrl",18:"Alt",19:"Pause",20:"CapsLock",27:"Esc",32:"Space",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"Left",38:"Up",39:"Right",40:"Down",44:"PrintScrn",45:"Insert",46:"Delete",59:";",61:"=",91:"Mod",92:"Mod",93:"Mod",106:"*",107:"=",109:"-",110:".",111:"/",127:"Delete",145:"ScrollLock",173:"-",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",63232:"Up",63233:"Down",63234:"Left",63235:"Right",63272:"Delete",63273:"Home",63275:"End",63276:"PageUp",63277:"PageDown",63302:"Insert"},Oo=0;Oo<10;Oo++)Ao[Oo+48]=Ao[Oo+96]=String(Oo)
...
var r=Ao[e.keyCode]
return null!=r&&!e.altGraphKey&&(3==e.keyCode&&e.code&&(r=e.code),Io(r,e,t))}function Ro(e){return"string"==typeof e?Do[e]:e}function Bo(e,t){for(var r=e.doc.sel.ranges,n=[],i=0;i<r.length;i++){for(var o=t(r[i]);n.length&&me(o.from,X(n).to)<=0;){var a=n.pop()
...
e.options.dragDrop&&gt&&!e.isReadOnly()&&"single"==r&&(i=u.contains(t))>-1&&(me((i=u.ranges[i]).from(),t)<0||t.xRel>0)&&(me(i.to(),t)>0||t.xRel<0)?function(e,t,r,n){var i=e.display,o=!1,u=qn(e,function(t){s&&(i.scroller.draggable=!1),e.state.draggingText=!1,tt(i.wrapper.ownerDocument,"mouseup",u),tt(i.wrapper.ownerDocument,"mousemove",c),tt(i.scroller,"dragstart",d),tt(i.scroller,"drop",u),o||(lt(t),n.addNew||Ri(e.doc,r,null,null,n.extend),s||a&&9==l?setTimeout(function(){i.wrapper.ownerDocument.body.focus(),i.input.focus()},20):i.input.focus())}),c=function(e){o=o||Math.abs(t.clientX-e.clientX)+Math.abs(t.clientY-e.clientY)>=10},d=function(){return o=!0}
s&&(i.scroller.draggable=!0),e.state.draggingText=u,u.copy=!n.moveOnDrag,i.scroller.dragDrop&&i.scroller.dragDrop(),Je(i.wrapper.ownerDocument,"mouseup",u),Je(i.wrapper.ownerDocument,"mousemove",c),Je(i.scroller,"dragstart",d),Je(i.scroller,"drop",u),pn(e),setTimeout(function(){return i.input.focus()},20)}(e,n,t,o):function(e,t,r,n){var i=e.display,o=e.doc
lt(t)
...
function g(t){e.state.selectingText=!1,p=1/0,lt(t),i.input.focus(),tt(i.wrapper.ownerDocument,"mousemove",m),tt(i.wrapper.ownerDocument,"mouseup",v),o.history.lastSelOrigin=null}var m=qn(e,function(t){ft(t)?function t(r){var a=++p,l=on(e,r,!0,"rectangle"==n.unit)
...
e.state.selectingText=v,Je(i.wrapper.ownerDocument,"mousemove",m),Je(i.wrapper.ownerDocument,"mouseup",v)}(e,n,t,o)}(t,n,o,e):dt(e)==r.scroller&&lt(e):2==i?(n&&Ri(t.doc,n),setTimeout(function(){return r.input.focus()},20)):3==i&&(C?ua(t,e):pn(t)))}}function aa(e,t,r){if("char"==r)return new gi(t,t)
...
!this.cm.isReadOnly()&&this.pollContent()||Un(this.cm,function(){return Xn(e.cm)})},Oa.prototype.setUneditable=function(e){e.contentEditable="false"},Oa.prototype.onKeyPress=function(e){0==e.charCode||this.composing||(e.preventDefault(),this.cm.isReadOnly()||qn(this.cm,ka)(this.cm,String.fromCharCode(null==e.charCode?e.keyCode:e.charCode),0))},Oa.prototype.readOnlyChanged=function(e){this.div.contentEditable=String("nocursor"!=e)},Oa.prototype.onContextMenu=function(){},Oa.prototype.resetPosition=function(){},Oa.prototype.needsContentAttribute=!0
var Ha=function(e){this.cm=e,this.prevInput="",this.pollingFast=!1,this.polling=new R,this.hasSelection=!1,this.composing=null}
Ha.prototype.init=function(e){var t=this,r=this,n=this.cm
this.createField(e)
var i=this.textarea
function o(e){if(!nt(n,e)){if(n.somethingSelected())xa({lineWise:!1,text:n.getSelections()})
else{if(!n.options.lineWiseCopyCut)return
var t=La(n)
xa({lineWise:!0,text:t.text}),"cut"==e.type?n.setSelections(t.ranges,null,K):(r.prevInput="",i.value=t.text.join("\n"),H(i))}"cut"==e.type&&(n.state.cutIncoming=!0)}}e.wrapper.insertBefore(this.wrapper,e.wrapper.firstChild),g&&(i.style.width="0px"),Je(i,"input",function(){a&&l>=9&&t.hasSelection&&(t.hasSelection=null),r.poll()}),Je(i,"paste",function(e){nt(n,e)||Ca(e,n)||(n.state.pasteIncoming=!0,r.fastPoll())}),Je(i,"cut",o),Je(i,"copy",o),Je(e.scroller,"paste",function(t){br(e,t)||nt(n,t)||(n.state.pasteIncoming=!0,r.focus())}),Je(e.lineSpace,"selectstart",function(t){br(e,t)||lt(t)}),Je(i,"compositionstart",function(){var e=n.getCursor("from")
r.composing&&r.composing.range.clear(),r.composing={start:e,range:n.markText(e,n.getCursor("to"),{className:"CodeMirror-composing"})}}),Je(i,"compositionend",function(){r.composing&&(r.poll(),r.composing.range.clear(),r.composing=null)})},Ha.prototype.createField=function(e){this.wrapper=Ma(),this.textarea=this.wrapper.firstChild},Ha.prototype.prepareSelection=function(){var e=this.cm,t=e.display,r=e.doc,n=sn(e)
...
if("/"==n)return e.eat("*")?(t.tokenize=m,m(e,t)):e.eat("/")?(e.skipToEnd(),p("comment","comment")):je(e,t,1)?(function(e){for(var t,r=!1,n=!1;null!=(t=e.next());){if(!r){if("/"==t&&!n)return
...
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function D(e){return function t(r){return r==e?L():";"==e?S():L(t)}}function P(e,t){return"var"==e?L(W("vardef",t.length),he,D(";"),z):"keyword a"==e?L(W("form"),I,P,z):"keyword b"==e?L(W("form"),P,z):"keyword d"==e?C.stream.match(/^\s*$/,!1)?L():L(W("stat"),R,D(";"),z):"debugger"==e?L(D(";")):"{"==e?L(W("}"),te,z):";"==e?L():"if"==e?("else"==C.state.lexical.info&&C.state.cc[C.state.cc.length-1]==z&&C.state.cc.pop()(),L(W("form"),I,P,z,ye)):"function"==e?L(Se):"for"==e?L(W("form"),be,P,z):"class"==e||u&&"interface"==t?(C.marked="keyword",L(W("form"),Me,z)):"variable"==e?u&&"declare"==t?(C.marked="keyword",L(P)):u&&("module"==t||"enum"==t||"type"==t)&&C.stream.match(/^\s*\w/,!1)?(C.marked="keyword","enum"==t?L(Re):"type"==t?L(oe,D("operator"),oe,D(";")):L(W("form"),pe,D("{"),W("}"),te,z,z)):u&&"namespace"==t?(C.marked="keyword",L(W("form"),H,te,z)):u&&"abstract"==t?(C.marked="keyword",L(P)):L(W("stat"),_):"switch"==e?L(W("form"),I,D("{"),W("}","switch"),te,z,z):"case"==e?L(H,D(":")):"default"==e?L(D(":")):"catch"==e?L(W("form"),A,D("("),Le,D(")"),P,z,O):"export"==e?L(W("stat"),We,z):"import"==e?L(W("stat"),De,z):"async"==e?L(P):"@"==t?L(H,P):S(W("stat"),H,D(";"),z)}function H(e,t){return F(e,t,!1)}function E(e,t){return F(e,t,!0)}function I(e){return"("!=e?S():L(W(")"),H,D(")"),z)}function F(e,t,r){if(C.state.fatArrowAt==C.stream.start){var n=r?U:G
if("("==e)return L(A,W(")"),J(Le,")"),z,D("=>"),n,O)
if("variable"==e)return S(A,pe,D("=>"),n,O)}var i=r?j:B
return w.hasOwnProperty(e)?L(i):"function"==e?L(Se,i):"class"==e||u&&"interface"==t?(C.marked="keyword",L(W("form"),Te,z)):"keyword c"==e||"async"==e?L(r?E:H):"("==e?L(W(")"),R,D(")"),z,i):"operator"==e||"spread"==e?L(r?E:H):"["==e?L(W("]"),Fe,z,i):"{"==e?ee(Y,"}",null,i):"quasi"==e?S(V,i):"new"==e?L(function(e){return function(t){return"."==t?L(e?$:q):"variable"==t&&u?L(ce,e?j:B):S(e?E:H)}}(r)):"import"==e?L(H):L()}function R(e){return e.match(/[;\}\)\],]/)?S():S(H)}function B(e,t){return","==e?L(H):j(e,t,!1)}function j(e,t,r){var n=0==r?B:j,i=0==r?H:E
...
if("?"==t)return L(re)}}function ne(e){if(u&&":"==e)return C.stream.match(/^\s*\w+\s+is\b/,!1)?L(H,ie,oe):L(oe)}function ie(e,t){if("is"==t)return C.marked="keyword",L()}function oe(e,t){return"keyof"==t||"typeof"==t?(C.marked="keyword",L("keyof"==t?oe:E)):"variable"==e||"void"==t?(C.marked="type",L(ue)):"string"==e||"number"==e||"atom"==e?L(ue):"["==e?L(W("]"),J(oe,"]",","),z,ue):"{"==e?L(W("}"),J(le,"}",",;"),z,ue):"("==e?L(J(se,")"),ae):"<"==e?L(J(oe,">"),oe):void 0}function ae(e){if("=>"==e)return L(oe)}function le(e,t){return"variable"==e||"keyword"==C.style?(C.marked="property",L(le)):"?"==t?L(le):":"==e?L(oe):"["==e?L(H,re,D("]"),le):void 0}function se(e,t){return"variable"==e&&C.stream.match(/^\s*[?:]/,!1)||"?"==t?L(se):":"==e?L(oe):S(oe)}function ue(e,t){return"<"==t?L(W(">"),J(oe,">"),z,ue):"|"==t||"."==e||"&"==t?L(oe):"["==e?L(D("]"),ue):"extends"==t||"implements"==t?(C.marked="keyword",L(oe)):void 0}function ce(e,t){if("<"==t)return L(W(">"),J(oe,">"),z,ue)}function de(){return S(oe,fe)}function fe(e,t){if("="==t)return L(oe)}function he(e,t){return"enum"==t?(C.marked="keyword",L(Re)):S(pe,re,me,ve)}function pe(e,t){return u&&M(t)?(C.marked="keyword",L(pe)):"variable"==e?(T(t),L()):"spread"==e?L(pe):"["==e?ee(pe,"]"):"{"==e?ee(ge,"}"):void 0}function ge(e,t){return"variable"!=e||C.stream.match(/^\s*:/,!1)?("variable"==e&&(C.marked="property"),"spread"==e?L(pe):"}"==e?S():L(D(":"),pe,me)):(T(t),L(me))}function me(e,t){if("="==t)return L(E)}function ve(e){if(","==e)return L(he)}function ye(e,t){if("keyword b"==e&&"else"==t)return L(W("form","else"),P,z)}function be(e,t){return"await"==t?L(be):"("==e?L(W(")"),we,D(")"),z):void 0}function we(e){return"var"==e?L(he,D(";"),ke):";"==e?L(ke):"variable"==e?L(xe):S(H,D(";"),ke)}function xe(e,t){return"in"==t||"of"==t?(C.marked="keyword",L(H)):L(B,ke)}function ke(e,t){return";"==e?L(Ce):"in"==t||"of"==t?(C.marked="keyword",L(H)):S(H,D(";"),Ce)}function Ce(e){")"!=e&&L(H)}function Se(e,t){return"*"==t?(C.marked="keyword",L(Se)):"variable"==e?(T(t),L(Se)):"("==e?L(A,W(")"),J(Le,")"),z,ne,P,O):u&&"<"==t?L(W(">"),J(de,">"),z,Se):void 0}function Le(e,t){return"@"==t&&L(H,Le),"spread"==e?L(Le):u&&M(t)?(C.marked="keyword",L(Le)):S(pe,re,me)}function Te(e,t){return"variable"==e?Me(e,t):Ne(e,t)}function Me(e,t){if("variable"==e)return T(t),L(Ne)}function Ne(e,t){return"<"==t?L(W(">"),J(de,">"),z,Ne):"extends"==t||"implements"==t||u&&","==e?("implements"==t&&(C.marked="keyword"),L(u?oe:H,Ne)):"{"==e?L(W("}"),Ae,z):void 0}function Ae(e,t){return"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t||u&&M(t))&&C.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(C.marked="keyword",L(Ae)):"variable"==e||"keyword"==C.style?(C.marked="property",L(u?Oe:Se,Ae)):"["==e?L(H,re,D("]"),u?Oe:Se,Ae):"*"==t?(C.marked="keyword",L(Ae)):";"==e?L(Ae):"}"==e?L():"@"==t?L(H,Ae):void 0}function Oe(e,t){return"?"==t?L(Oe):":"==e?L(oe,me):"="==t?L(E):S(Se)}function We(e,t){return"*"==t?(C.marked="keyword",L(Ie,D(";"))):"default"==t?(C.marked="keyword",L(H,D(";"))):"{"==e?L(J(ze,"}"),Ie,D(";")):S(P)}function ze(e,t){return"as"==t?(C.marked="keyword",L(D("variable"))):"variable"==e?S(E,ze):void 0}function De(e){return"string"==e?L():"("==e?S(H):S(Pe,He,Ie)}function Pe(e,t){return"{"==e?ee(Pe,"}"):("variable"==e&&T(t),"*"==t&&(C.marked="keyword"),L(Ee))}function He(e){if(","==e)return L(Pe,He)}function Ee(e,t){if("as"==t)return C.marked="keyword",L(Pe)}function Ie(e,t){if("from"==t)return C.marked="keyword",L(H)}function Fe(e){return"]"==e?L():S(J(E,"]"))}function Re(){return S(W("form"),pe,D("{"),W("}"),J(Be,"}"),z,z)}function Be(){return S(pe,me)}function je(e,t,r){return t.tokenize==g&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}return z.lex=!0,{startState:function(e){var t={tokenize:g,lastType:"sof",cc:[],lexical:new x((e||0)-o,0,"block",!1),localVars:r.localVars,context:r.localVars&&{vars:r.localVars},indented:e||0}
